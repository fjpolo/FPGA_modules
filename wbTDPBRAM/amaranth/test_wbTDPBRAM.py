...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to wbTDPBRAM() in wbTDPBRAM.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your wbTDPBRAM.v for the exact path:
    ...
    # For a simple wbTDPBRAM, dut.count.value *might* work, depending on Verilator's flattening.
