...
iverilog -g2012 -I/path/to/uvm-1.2/src -D UVM_NO_DEPRECATED -o simv tb_top.sv dut_wrapper.sv wbTDPBRAM.v
vvp -n simv +UVM_TESTNAME=wbTDPBRAM_test +UVM_VERBOSITY=UVM_MEDIUM
