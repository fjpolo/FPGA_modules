...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to wbDPBRAM() in wbDPBRAM.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your wbDPBRAM.v for the exact path:
    ...
    # For a simple wbDPBRAM, dut.count.value *might* work, depending on Verilator's flattening.
